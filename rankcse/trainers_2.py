...
class CLTrainer(Trainer):
    ...
    def compute_loss(self, model, inputs, return_outputs=False):
        ...
        if self.model_args.loss_type == "hinge":
            ...
            # loss = loss_o + torch.max(self.model_args.baseE_lmb * loss_baseE, self.model_args.t_lmb * kd_loss)
            ...
            loss = loss_o + self.model_args.baseE_lmb * loss_baseE + self.model_args.t_lmb * (kd_loss + sd_loss)
            # loss = loss_o + self.model_args.baseE_lmb * loss_baseE
        else:

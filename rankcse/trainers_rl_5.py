        ...
        for epoch in range(epochs_trained, num_train_epochs):
            ...
            for step, inputs in enumerate(epoch_iterator):
                ...
                with torch.no_grad():
                    ...
                    # DDPG
                    # inputs["policy_model1_target"] = policy_model1_target
                    # inputs["policy_model2_target"] = policy_model2_target
                ...
                if (step + 1) % self.args.gradient_accumulation_steps == 0 or (
                    ...
                    with torch.no_grad():
                        ...
                        second_rewards = self.model.second_rewards
                        ...
                        # 7812
                        if step < 7812:
                            action, weights = policy_model2.take_action(value2_state)
                            value2 = Critic_model2(*value2_state, action)
                        else:
                            value2 = value2
                        # 7813
                        if step > 7813:
